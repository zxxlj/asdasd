...
<html lang="zh-cn">
<head>
<jsp:include page="/IcdMeta.jsp" />
<title>会员首页</title>
<jsp:include page="/IcdLink.jsp" />
</head>
<body>
	<jsp:include page="/IcdTop.jsp"></jsp:include>
						...
						<tbody>
							<c:forEach items="${page.items}" var="ord">
								<tr>
									...
									<td class="text-center">
											<%--<a href="${ctx}/member/orders/detail?id=${ord.id}">详情</a>--%>
											<%--<a href="${ctx}/product_detail?id=${item.product.id}">详情</a>--%>



										<c:if test="${ord.status==4}" var="flag">
	...
	<jsp:include page="/IcdBottom.jsp"></jsp:include>
