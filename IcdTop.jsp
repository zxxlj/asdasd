	...
	<div id="toolbar">
		<div class="wrapper row">
			...
			<c:if test="${!flag}">
				...
				<div class="col-xs-4"></div>
				<div class="col-xs-3" style="text-align: right;">
					<a href="${ctx}/MemberLogin.jsp">登录</a> <a
						href="${ctx}/MemberRegister.jsp">注册</a>
				</div>
			</c:if>
		</div>
	</div>
	...
	<div id="subject">
		<div class="wrapper row">
			<div class="col-xs-2" id="logo">
				<a href="${ctx}/main "> <img src="${ctx}/images/logo.png"
					style="width: 160px;" />
				</a>
			</div>
			...
			<div class="col-xs-2" id="cart">
				<a href="${ctx}/ViewCart.jsp" class="btn btn-primary"
